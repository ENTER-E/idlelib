...
class EditorWindow:
    ...
    def __init__(self, flist=None, filename=None, key=None, root=None):
        ...
        bgcolor = idleConf.GetHighlight(idleConf.CurrentTheme(), 'console')['background']
        self.text_frame = text_frame = Frame(top, bg=bgcolor)
    ...
    def set_status_bar(self):
        ...
        sep = Frame(self.top, height=2, borderwidth=1, bg='#fff')
        if sys.platform == "darwin":
    ...
    def make_rmenu(self):
        rmenu = Menu(self.text, tearoff=0, bg='#abc', fg='#fff')
        for item in self.rmenu_specs:
